...
public final class C2MEmod implements ClientModInitializer {
    ...
    private void tick(MinecraftClient client) {
        ...
        while (OPEN_SETTINGS.wasPressed()) {
            client.setScreen(new MobSettingsScreen(client.currentScreen, config, state));
        }
        ...
        for (Entity entity : client.world.getEntities()) {
            ...
            if (config.hostileOnly && !hostile) continue;
            ...
            if (chargedCreeper) color = config.chargedCreeperColor;
